...
export type TemplateParserMap<T extends string> = ParamsParserMap<
  MergeParamGroups<InferParamGroups<T>>
>;

export type RouteMiddleware = (next: RouteComponent) => RouteComponent;
