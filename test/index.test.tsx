...
test('middleware', () => {
  ...
  const LoginRedirect = () => <Navigate to={router.login().$} replace />;
...
test('nested pages', () => {
  ...
  expect(router.routeA.children.routeB.render() as any).toEqual(<TestPageB />);
  expect(router.routeA.children.routeB.children.routeC.render() as any).toEqual(
    <TestPageC />
  );
});
